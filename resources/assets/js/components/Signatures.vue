	...
	<div>
		<div class="panel panel-default" v-for="signature in signatures">
			...
			<div class="panel-footer">
				<span class="glyphicon glyphicon-calendar" id="visit"></span> {{ signature.date }} | <span class="glyphicon glyphicon-flag" id="comment"></span>
			...
			fetch(page = 1){
				axios.get(this.endpoint + page)
					.then(({data}) => {
						...
						this.pageCount = data.emta.last_page;
					})
			}
		},
